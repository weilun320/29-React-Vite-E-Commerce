    ...
    <>
      <div className="pt-5 mb-5">
        <div className="w-100 position-relative mt-5 pt-2">
          <img alt="Christmas" className="object-fit-cover w-100" height="580" src="../public/assets/christmas-background.jpg" />
          <div className="position-absolute top-50 start-50 translate-middle text-center">
            <h1 className="fw-bold text-light">Celebrate the Joy of Christmas</h1>
            <p className="fs-5 text-light">Grab your gift now and get a free wrapping!</p>
