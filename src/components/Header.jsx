...
function Header() {
  return (
    <>
      <div className="pt-4">
        <div className="w-100 position-relative mt-5 pt-3">
          <img alt="Christmas" className="object-fit-cover w-100" height="600" loading="lazy" src="../public/assets/christmas-background.jpg" />
